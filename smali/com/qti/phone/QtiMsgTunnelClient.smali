...
.method public static declared-synchronized getInstance()Lcom/qti/phone/QtiMsgTunnelClient;
    ...
    .line 84
    :try_start_0
    const-class v1, Lcom/qti/phone/QtiMsgTunnelClient;
    ...
    .line 85
    :try_start_1
    sget-object v2, Lcom/qti/phone/QtiMsgTunnelClient;->mInstance:Lcom/qti/phone/QtiMsgTunnelClient;

    if-nez v2, :cond_0

    const-string v2, "QtiMsgTunnelClient"

    const-string v3, "QtiMsgTunnelClient instance null !!! "
